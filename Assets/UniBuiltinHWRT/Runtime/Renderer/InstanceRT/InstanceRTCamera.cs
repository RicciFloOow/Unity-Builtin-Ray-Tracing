...
namespace UniBuiltinHWRT
{
    ...
    {
        #region ----Builtin Instance HWRT Rendering Pass----
        private const string k_SimpleHWRTPassName = "InstanceHWRayTracing";//必须要与目标shader中的Pass Name一致
        ...
        private void ExecuteBuiltinInstanceHWRT(ref CommandBuffer cmd, RayTracingShader rts)
        {
            ...
            cmd.SetGlobalBuffer(k_ShaderProperty_Buffer_InstanceAACuboidMatParamBuffer, m_InstanceMaterialComputeBuffer);
        ...
        private void SetupBuiltinHWRTRenderingPass()
        {
            ...
            //
            ExecuteBuiltinInstanceHWRT(ref m_BuiltinHWRTRenderingPassBuffer, InstanceRTShader);
            //
